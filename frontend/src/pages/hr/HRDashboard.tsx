...
const HRDashboard: React.FC = () => {
  ...
  const recentActivity = [
    {
      action: "Approved onboarding for Sarah Miller",
      time: "10 min ago",
      type: "approved",
    },
    {
      action: "Rejected visa document for Mike Johnson",
      time: "1 hour ago",
      type: "rejected",
    },
    {
      action: "Generated token for new hire",
      time: "2 hours ago",
      type: "pending",
    },
    {
      action: "Approved EAD for Lisa Wang",
      time: "3 hours ago",
      type: "approved",
    },
  ];
